...
const LumiereStore = (() => {
  ...
  const defaults = {
    ...
    categories: [
      ...
      { id: 'cat-accessories', name: 'Earrings', nameAr: 'حلقان', slug: 'earrings', sort: 3, image: 'https://images.unsplash.com/photo-1617038220319-496d8d1736f4?w=800&q=80', featured: true },
    ...
    products: [
      ...
      { id: 'p-e1', name: 'Gold Hoop Earrings', nameAr: 'حلق هوب دهب', category: 'Earrings', categorySlug: 'earrings', price: 280, rating: 5, reviews: 156, image: 'https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=600&q=80', images: ['https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=800&q=80'], badge: 'Best Seller', featured: true, bestseller: true, stock: 45, descAr: 'حلق هوب خفيف — ترند كل يوم.', descEn: 'Lightweight gold-tone hoop earrings.' },
      { id: 'p-e2', name: 'Zircon Drop Earrings', nameAr: 'حلق zircon', category: 'Earrings', categorySlug: 'earrings', price: 320, rating: 5, reviews: 88, image: 'https://images.unsplash.com/photo-1617038220319-496d8d1736f4?w=600&q=80', images: ['https://images.unsplash.com/photo-1617038220319-496d8d1736f4?w=800&q=80'], badge: 'New', featured: true, bestseller: true, stock: 32, descAr: 'حلق نازل بحجر لامع — شكل بنت لابساه.', descEn: 'Zircon drop earrings with a dressy look.' },
      { id: 'p-e3', name: 'Pearl Stud Earrings', nameAr: 'حلق لؤلؤ', category: 'Earrings', categorySlug: 'earrings', price: 260, rating: 5, reviews: 64, image: 'https://images.unsplash.com/photo-1488799812881-957129749661?w=600&q=80', images: ['https://images.unsplash.com/photo-1488799812881-957129749661?w=800&q=80'], badge: '', featured: true, bestseller: false, stock: 40, descAr: 'حلق لؤلؤ كلاسيك — يركب مع كل حاجة.', descEn: 'Classic pearl stud earrings.' },
  ...
  async function placeOrder({
    ...
    const payload = {
      ...
      total,
      userId: userId || null,
      items: (items || []).map(i => ({ id: i.id, name: i.name, qty: i.qty, price: i.price, image: i.image || '', color: i.color || null }))
    };
    ...
    const order = {
      ...
      items: payload.items.map(i => ({ productId: i.id, name: i.name, qty: i.qty, price: i.price, image: i.image || '', color: i.color || null }))
    };
    update(data => {
