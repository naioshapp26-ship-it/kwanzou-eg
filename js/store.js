...
const LumiereStore = (() => {
  ...
  const defaults = {
    settings: {
      ...
      tagline: 'Kwanzou EG — Stainless, Bags, Makeup & Perfumes',
      taglineAr: 'Kwanzou EG — استالس، شنط، ميكب وبرفانات',
      taglineEn: 'Kwanzou EG — Stainless, Bags, Makeup & Perfumes',
      subtitle: 'Stainless accessories, handbags, makeup and perfumes — all in one place.',
      subtitleAr: 'إكسسوارات استالس، شنط، ميكب وبرفانات — كل حاجة في مكان واحد.',
      subtitleEn: 'Stainless accessories, handbags, makeup and perfumes — all in one place.',
      ...
      heroImage: 'https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=1920&q=85',
      heroAccent1: 'https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=650&q=80',
      heroAccent2: 'https://images.unsplash.com/photo-1596462502278-27bfdd403348?w=650&q=80',
      currency: 'EGP',
      currencySymbol: 'ج.م'
    },
    categories: [
