...
module.exports = {
  settings: {
    ...
    subtitleAr: 'اكتشفي مجوهرات فاخرة، حقائب يد، وإكسسوارات مميزة من Kwanzou EG.',
  ...
  products: [
    { id: 'p1', name: 'Étoile Diamond Necklace', nameAr: 'قلادة إتوال الماسية', category: 'Necklaces', categorySlug: 'necklaces', price: 8900, rating: 5, reviews: 84, image: 'https://images.unsplash.com/photo-1599643478518-a784e5dc4c42?w=600&q=80', images: ['https://images.unsplash.com/photo-1599643478518-a784e5dc4c42?w=800&q=80'], badge: 'New', featured: true, bestseller: false, stock: 12, descAr: 'قلادة فاخرة مرصعة بأحجار لامعة.', descEn: 'Luxury necklace with brilliant stones.' },
    { id: 'p2', name: 'Pearl Cascade Earrings', nameAr: 'أقراط اللؤلؤ', category: 'Earrings', categorySlug: 'earrings', price: 4200, rating: 5, reviews: 156, image: 'https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=600&q=80', images: ['https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=800&q=80'], badge: '', featured: true, bestseller: true, stock: 24, descAr: 'أقراط لؤلؤ طبيعي.', descEn: 'Natural pearl earrings.' },
    { id: 'p3', name: 'Maison Leather Tote', nameAr: 'حقيبة جلدية', category: 'Handbags', categorySlug: 'handbags', price: 12500, rating: 5, reviews: 92, image: 'https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=600&q=80', images: ['https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=800&q=80'], badge: 'Best Seller', featured: true, bestseller: true, stock: 8, descAr: 'حقيبة يد جلد فاخر.', descEn: 'Premium leather tote.' }
  ],
  collections: [
  ...
  testimonials: [
    { id: 't1', name: 'Sophia Laurent', location: 'Paris, France', text: 'Extraordinary jewelry quality.', textAr: 'جودة المجوهرات استثنائية.', textEn: 'Extraordinary jewelry quality.', avatar: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&q=80', featured: false },
    { id: 't2', name: 'Amara Chen', location: 'New York, USA', text: 'Beautiful craftsmanship.', textAr: 'حرفية رائعة.', textEn: 'Beautiful craftsmanship.', avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=100&q=80', featured: true },
    { id: 't3', name: 'Layla Al-Rashid', location: 'Dubai, UAE', text: 'Fast shipping and authentic products.', textAr: 'شحن سريع ومنتجات أصلية.', textEn: 'Fast shipping and authentic products.', avatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=100&q=80', featured: false }
  ],
  users: [
