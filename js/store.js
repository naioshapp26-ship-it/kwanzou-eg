...
const LumiereStore = (() => {
  ...
  const defaults = {
    ...
    products: [
      { id: 'p1', name: 'Étoile Diamond Necklace', nameAr: 'سلسلة دياموند', category: 'Necklaces', categorySlug: 'necklaces', price: 8900, rating: 5, reviews: 84, image: 'https://images.unsplash.com/photo-1599643478518-a784e5dc4c42?w=600&q=80', images: ['https://images.unsplash.com/photo-1599643478518-a784e5dc4c42?w=800&q=80','https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=800&q=80'], badge: 'New', featured: true, bestseller: false, stock: 12, descAr: 'سلسلة حلوة مرصعة بحجر لامع، مطلية دهب. مناسبة للخروجات والمناسبات.', descEn: 'Luxury necklace with brilliant zirconia stones, 18K gold plated. Perfect for special occasions.' },
      { id: 'p2', name: 'Pearl Cascade Earrings', nameAr: 'حلق لؤلؤ', category: 'Earrings', categorySlug: 'earrings', price: 4200, rating: 5, reviews: 156, image: 'https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=600&q=80', images: ['https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=800&q=80'], badge: '', featured: true, bestseller: true, stock: 24, descAr: 'حلق لؤلؤ طبيعي، شكله أنيق وخفيف على الأذن.', descEn: 'Natural pearl earrings with elegant cascade design.' },
      { id: 'p3', name: 'Maison Leather Tote', nameAr: 'شنطة جلد', category: 'Handbags', categorySlug: 'handbags', price: 12500, rating: 5, reviews: 92, image: 'https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=600&q=80', images: ['https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=800&q=80'], badge: 'Best Seller', featured: true, bestseller: true, stock: 8, descAr: 'شنطة جلد كويسة مع تفاصيل دهب. مساحة كبيرة وشكلها شيك.', descEn: 'Premium Italian leather tote with gold details.' },
      { id: 'p4', name: 'Rose Gold Bangle Set', nameAr: 'طقم أساور دهب وردي', category: 'Jewelry', categorySlug: 'jewelry', price: 5800, rating: 4, reviews: 67, image: 'https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=600&q=80', images: ['https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=800&q=80'], badge: '', featured: true, bestseller: false, stock: 18, descAr: 'طقم 3 أساور مطلية دهب وردي. ينفع لوحده أو كطقم.', descEn: 'Set of 3 rose gold plated bangles.' },
      { id: 'p5', name: 'Silk Monogram Scarf', nameAr: 'طرحة حرير', category: 'Scarves & Silk', categorySlug: 'scarves', price: 1950, rating: 5, reviews: 203, image: 'https://images.unsplash.com/photo-1601925260368-ae2f83cf8b7f?w=600&q=80', images: ['https://images.unsplash.com/photo-1601925260368-ae2f83cf8b7f?w=800&q=80'], badge: '', featured: false, bestseller: true, stock: 35, descAr: 'طرحة حرير 100% بطبعة شيك. تكمل أي لوك.', descEn: '100% silk scarf with elegant monogram print.' },
      { id: 'p6', name: 'Classic Watch', nameAr: 'ساعة كلاسيك', category: 'Watches', categorySlug: 'watches', price: 21000, rating: 5, reviews: 41, image: 'https://images.unsplash.com/photo-1524592094714-0f0654e20314?w=600&q=80', images: ['https://images.unsplash.com/photo-1524592094714-0f0654e20314?w=800&q=80'], badge: 'Limited', featured: false, bestseller: true, stock: 5, descAr: 'ساعة شيك بحركة سويسرية. شكلها كلاسيك وبتكمل أي ستايل.', descEn: 'Luxury wristwatch with Swiss movement.' },
      { id: 'p7', name: 'Aviator Gold Sunglasses', nameAr: 'نظارة أفياتور دهب', category: 'Sunglasses', categorySlug: 'sunglasses', price: 3400, rating: 4, reviews: 78, image: 'https://images.unsplash.com/photo-1572635196237-14b3f281503f?w=600&q=80', images: ['https://images.unsplash.com/photo-1572635196237-14b3f281503f?w=800&q=80'], badge: '', featured: false, bestseller: true, stock: 15, descAr: 'نظارة شمس UV400 بإطار دهب. شكلها ترندي وتحمي من الشمس.', descEn: 'UV400 sunglasses with gold frame.' },
      { id: 'p8', name: 'Crystal Drop Ring', nameAr: 'خاتم كريستال', category: 'Jewelry', categorySlug: 'jewelry', price: 7200, rating: 5, reviews: 112, image: 'https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=600&q=80', images: ['https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=800&q=80'], badge: 'New', featured: false, bestseller: true, stock: 10, descAr: 'خاتم كريستال SWAROVSKI بشكل drop. لمعته حلوة أوي.', descEn: 'SWAROVSKI crystal drop ring design.' }
    ],
    collections: [
    ...
    testimonials: [
      { id: 't1', name: 'Sophia Laurent', location: 'Paris, France', text: 'The jewelry quality is extraordinary. Every piece feels like a heirloom — LUMIÈRE is my absolute favorite for accessories.', textAr: 'الدهب عندهم تحفة. كل حاجة شكلها فخم — Kwanzou أحلى مكان للإكسسوارات.', textEn: 'The jewelry quality is extraordinary. Every piece feels like a heirloom — LUMIÈRE is my absolute favorite for accessories.', avatar: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&q=80', featured: false },
      { id: 't2', name: 'Amara Chen', location: 'New York, USA', text: 'I\'ve collected handbags from every luxury house, and LUMIÈRE\'s craftsmanship rivals them all.', textAr: 'اشتريت شنط كتير، بس جودة Kwanzou من أحسن حاجة شوفتها.', textEn: 'I\'ve collected handbags from every luxury house, and LUMIÈRE\'s craftsmanship rivals them all.', avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=100&q=80', featured: true },
      { id: 't3', name: 'Layla Al-Rashid', location: 'Dubai, UAE', text: 'Fast shipping, authentic products, and the most beautiful accessories I\'ve ever owned.', textAr: 'التوصيل سريع، والمنتجات أصلية، وأحلى إكسسوارات اشتريتها.', textEn: 'Fast shipping, authentic products, and the most beautiful accessories I\'ve ever owned.', avatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=100&q=80', featured: false }
    ],
    users: [
  ...
  function mergeDefaults(data) {
    ...
    const defaultCatById = Object.fromEntries(defaults.categories.map(c => [c.id, c]));
    const defaultProductById = Object.fromEntries(defaults.products.map(p => [p.id, p]));
    const defaultCollectionById = Object.fromEntries(defaults.collections.map(c => [c.id, c]));
    const defaultTestimonialById = Object.fromEntries(defaults.testimonials.map(t => [t.id, t]));
    ...
    merged.categories = (data.categories && data.categories.length)
      ? data.categories.map((c, i) => {
          const def = defaultCatById[c.id] || defaults.categories[i % defaults.categories.length];
          return {
            ...def,
            ...c,
            slug: def.slug || c.slug || (c.name || '').toLowerCase().replace(/\s.*/, ''),
            nameAr: def.nameAr,
    ...
    merged.products = (data.products && data.products.length)
      ? data.products.map(p => {
          const def = defaultProductById[p.id];
          const base = {
            ...p,
            categorySlug: p.categorySlug || def?.categorySlug || (p.category || '').toLowerCase().split(' ')[0],
          ...
          return {
            ...
            nameAr: def.nameAr,
            descAr: def.descAr,
            categorySlug: def.categorySlug || base.categorySlug
          };
        })
      : merged.products;
    merged.collections = (data.collections && data.collections.length)
      ? data.collections.map(c => {
          const def = defaultCollectionById[c.id];
          return def ? { ...c, labelAr: def.labelAr, titleAr: def.titleAr } : c;
        })
      : merged.collections;
    merged.testimonials = (data.testimonials && data.testimonials.length)
      ? data.testimonials.map(t => {
          const def = defaultTestimonialById[t.id];
          return def ? { ...t, textAr: def.textAr } : t;
        })
      : merged.testimonials;
