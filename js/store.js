...
const LumiereStore = (() => {
  ...
  const defaults = {
    ...
    products: [
      { id: 'p1', name: 'Étoile Diamond Necklace', nameAr: 'قلادة إتوال الماسية', category: 'Necklaces', categorySlug: 'necklaces', price: 8900, rating: 5, reviews: 84, image: 'https://images.unsplash.com/photo-1599643478518-a784e5dc4c42?w=600&q=80', images: ['https://images.unsplash.com/photo-1599643478518-a784e5dc4c42?w=800&q=80','https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=800&q=80'], badge: 'New', featured: true, bestseller: false, stock: 12, descAr: 'قلادة فاخرة مرصعة بأحجار زirconia لامعة، مطلية بالذهب عيار 18. مثالية للمناسبات الخاصة.', descEn: 'Luxury necklace with brilliant zirconia stones, 18K gold plated. Perfect for special occasions.' },
